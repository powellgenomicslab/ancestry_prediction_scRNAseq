...
rule subset_common_snps:
    ...
    output:
        ...
        bed_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_1000g.pgen",
        bim_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_1000g.pvar",
        fam_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_1000g.psam",
    resources:
...
rule freebayes_prune_1000g:
    input:
        ...
        fam = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_data.psam",
    output:
        prune_out_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.prune.out",
        prune_out = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_data.prune.out",
        pgen_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.pgen",
        pvar_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.pvar",
        psam_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.psam",
        bed_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.bed",
        bim_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.bim",
        fam_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.fam",
        ...
        bim_temp = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_data_temp.pvar",
        bim_old = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_data_original.pvar",
        ...
        onek_popu = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.popu"
    resources:
    ...
    params:
        sif = input_dict["singularity_image"],
        bind = input_dict["bind_path"],
        out_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g",
        infile_1000g = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_1000g",
        infile = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_data",
        out = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_data"
    shell:
        """
...
rule freebayes_final_pruning: ### put in contingency for duplicated snps - remove from both 1000G and your dataset
    ...
    output:
        ...
        bed = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/final_subset_pruned_data.bed",
        bim = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/final_subset_pruned_data.bim",
        fam = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/final_subset_pruned_data.fam",
    resources:
...
rule freebayes_split_data:
    input:
        bed = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/final_subset_pruned_data.bed" 
    output:
        bed = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/split/final_subset_pruned_data.bed",
        bed_1000 = temp(output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/split/subset_pruned_1000g.bed"),
        bim_1000 = temp(output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/split/subset_pruned_1000g.bim"),
        fam_1000 = temp(output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/split/subset_pruned_1000g.fam")
    resources:
    ...
    params:
        ...
        outdir = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/split/",
        ref = output_dict["outdir"] +  "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g",
        sif = input_dict["singularity_image"],
        bind = input_dict["bind_path"]
    shell:
        """
...
rule freebayes_pca_1000g:
    input:
        bed_1000g = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.pgen",
        bim_1000g = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.pvar",
        fam_1000g = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g.psam",
        bed = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_data.pgen" 
    output:
        out = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.acount",
        eig_all = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.eigenvec.allele",
        eig_vec = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.eigenvec",
        eig = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.eigenval",
    resources:
    ...
    params:
        sif = input_dict["singularity_image"],
        bind = input_dict["bind_path"],
        infile = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g",
        out = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs"
    shell:
        """
...
rule freebayes_pca_project:
    input:
        ...
        frq = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.acount",
        scores = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs.eigenvec.allele"
    output:
        projected_scores = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/final_subset_pruned_data_pcs.sscore",
        projected_1000g_scores = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs_projected.sscore"
    resources:
    ...
    params:
        ...
        bind = input_dict["bind_path"],
        infile = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/final_subset_pruned_data",
        infile_1000g = output_dict["outdir"] + "/{pool}/individual_{individual}/common_snps/subset_pruned_1000g",
        out = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/final_subset_pruned_data_pcs",
        out_1000g = output_dict["outdir"] + "/{pool}/individual_{individual}/pca_projection/subset_pruned_1000g_pcs_projected"
    shell:
        """
